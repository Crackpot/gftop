...
from xmc_mn.equipment.models import Equipment
from xmc_mn.settings import MEDIA_ROOT

class Dimension(models.Model):
    name = models.CharField('名称' , max_length=12, blank=False , null=False)
    dimension = models.CharField('尺寸', max_length=40, blank=False, null=False)
...
class Material(models.Model):
    ...
    dimension = models.ForeignKey(Dimension, verbose_name = '幅面') #幅面
    archived_time = models.DateTimeField('存档时间', blank=False) #存档时间
    #utilizing = models.CharField('使用地点', max_length=20) #使用地点
    utilizing = models.ForeignKey(Equipment, verbose_name='使用地点') #使用地点
...
class Lending(models.Model):
    ...
    lender = models.ForeignKey(User , verbose_name='借出人')
