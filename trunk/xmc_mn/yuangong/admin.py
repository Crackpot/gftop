...
class YuangongAdmin(admin.ModelAdmin):
    ...
    list_display = ('xingming', 'xingbie',  'chushengnianyue')
    ...
    def export_csv(self, request, queryset):
        ...
        datadict = [
            ...
            'zhengzhimianmao', 'rudangtuanshijian', 'gongbie', 'gongzhong',  'danwei', 'lianxidianhua',
...
#            '家庭成员关系3','家庭成员姓名3','家庭成员出生年月3','家庭成员联系电话3','家庭成员单位3',)
        ...
        for o in queryset:
            ...
            (o.id, o.xingming, o.xingbie, o.chushengnianyue, o.cangongshijian, o.baoxianhao, o.renshikahao, o.shenfenzhenghao, o.zhuzhi, o.jiguan,
             ...
             o.zhengzhimianmao, o.rudangtuanshijian, o.gongbie, o.gongzhong,  o.danwei, o.lianxidianhua,
